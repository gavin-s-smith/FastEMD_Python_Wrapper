Update by Gavin Smith: This readme refers to the code as downloaded from the site listed. Not all parts of the code exist in the repo since
only that required for the python lib is included.
